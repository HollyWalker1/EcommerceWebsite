    ...
    <div class="split">
      ...
      <div class="row mx-auto container-fluid">
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          ...
          <h5 class="p-name">126pc Art Set</h5>
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          ...
          <h5 class="p-name">Daler-Rowney A4 Artboard Pad</h5>
          <h4 class="p-price">£12.50</h4>
          <button class="add-to-cart">Add to Cart</button>
        </div>
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          ...
          <h5 class="p-name">Stretched Canvases A2 4 Pack</h5>
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          ...
          <h5 class="p-name">FS60X Brother Sewing Machine</h5>
